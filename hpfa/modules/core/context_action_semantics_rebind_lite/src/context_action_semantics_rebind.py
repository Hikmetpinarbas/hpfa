...
def build_rebind(
    ...
    *,
    ...
    return {
        ...
        "context_zone_ontology_id": mvc.get("context_zone_ontology_id"),
        "context_zone_domain": list(mvc.get("context_zone_domain") or []),
        "context_zone_final_third_observable": mvc.get("context_zone_final_third_observable") is True,
        "context_zone_penalty_area_observable": mvc.get("context_zone_penalty_area_observable") is True,
        "context_zone_penalty_area_unobservable_reason": mvc.get("context_zone_penalty_area_unobservable_reason"),
...
def _fail_payload(blocks: list[str], reviews: list[str], context_count: int, nucleus_count: int) -> dict[str, Any]:
    return {
        ...
        "context_zone_ontology_id": None,
        "context_zone_domain": [],
        "context_zone_final_third_observable": False,
        "context_zone_penalty_area_observable": False,
        "context_zone_penalty_area_unobservable_reason": "UPSTREAM_CONTEXT_REJECTED",
        "reference_participation_context_adds_action_volume": False,
        "same_timestamp_internal_ordering_allowed": False,
        "source_row_order_is_temporal_truth": False,
