...
def _comparison_admission(signal: Any) -> dict[str, Any]:
    ...
    if missing:
        return {**base, "missing_comparison_fields": missing}
    ...
    unresolved_dimensions = [
        dim for dim in exact_dimensions
    ...
    same_lineage = [
        current_key for current_key, reference_key in lineage_pairs
    ...
    incomplete_lineage = [
        key for current_key, reference_key in lineage_pairs
