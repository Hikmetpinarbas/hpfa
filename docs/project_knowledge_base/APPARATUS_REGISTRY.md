...
| APP-PHASE-001 | Phase Apparatus | Phase truth üretmeden phase candidate tagging yapmak | event-like rows, time/order, action labels, zones | phase candidates | CANDIDATE_ONLY | Time Surface Gate, Canonical Event Lite | SPEC |
...
| APP-SEQUENCE-001 | Sequence Apparatus | Primitive/phase/window evidence'dan sequence candidate üretmek | ordered event-like rows, primitive candidates, phase candidates, time windows | sequence candidates | CANDIDATE_ONLY | Canonical Event Lite, Phase Candidate Lite, Time Surface Gate | IDEA |
