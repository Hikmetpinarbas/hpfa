...
if git -C "$REPO" show-ref --verify --quiet "refs/heads/$BRANCH"; then git -C "$REPO" switch "$BRANCH"; else git -C "$REPO" switch --track "origin/$BRANCH"; fi
