...
def write_summary(out_dir: Path, steps: list[dict[str, Any]], input_status: dict[str, Any]) -> dict[str, Any]:
    ...
    valid_run = bool(input_status.get("input_surface_ready")) and all_steps_passed and evidence_nonzero
    report = {
        ...
        "outputs": {"json": str(out_dir / RUN_JSON), "txt": str(out_dir / RUN_TXT)},
    }
